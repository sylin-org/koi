...
impl KoiClient {
    ...
    pub fn unregister(&self, id: &str) -> Result<()> {
        let url = format!("{}/v1/services/{id}", self.endpoint);
    ...
    pub fn browse_stream(&self, service_type: &str) -> Result<SseStream> {
        let url = format!("{}/v1/browse", self.endpoint);
        let resp = self
            .stream_agent()
            .get(&url)
    ...
    pub fn admin_status(&self) -> Result<DaemonStatus> {
        let url = format!("{}/v1/admin/status", self.endpoint);
    ...
    pub fn admin_registrations(&self) -> Result<Vec<AdminRegistration>> {
        let url = format!("{}/v1/admin/registrations", self.endpoint);
        let resp = self.agent.get(&url).call().map_err(map_error)?;
        resp.into_json()
            .map_err(|e| ClientError::Decode(e.to_string()))
    }
    ...
    pub fn admin_inspect(&self, id: &str) -> Result<AdminRegistration> {
        let url = format!("{}/v1/admin/registrations/{id}", self.endpoint);
        let resp = self.agent.get(&url).call().map_err(map_error)?;
        resp.into_json()
            .map_err(|e| ClientError::Decode(e.to_string()))
    }
    ...
    pub fn admin_drain(&self, id: &str) -> Result<()> {
        let url = format!("{}/v1/admin/registrations/{id}/drain", self.endpoint);
        self.agent.post(&url).call().map_err(map_error)?;
        Ok(())
    }

    pub fn admin_revive(&self, id: &str) -> Result<()> {
        let url = format!("{}/v1/admin/registrations/{id}/revive", self.endpoint);
        self.agent.post(&url).call().map_err(map_error)?;
        Ok(())
    }
