...
|---|---|---|---|---|---|
| `R06/windows-shared-shell` | cachyos-linux | windows | Exact desktop e010086/shared b4c32fa; normal NSIS/shared-shell physical checks with fresh guards; [procedure and expiry](reports/R06-shared-shell.md#bounded-production-native-requests) | acknowledged | [Windows acknowledgement](../../../fleet/windows/journal.md#2026-09-05-37--r06-windows-shared-shell-acknowledged); exact old package recovery and clean candidate retained, no installed-host mutation yet; verification only |
| `R06/alpine-shared-shell` | cachyos-linux | alpine-linux | Exact e010086 product, APKBUILD bd8121c/shared b4c32fa; native musl package/shared-shell checks; [procedure and expiry](reports/R06-shared-shell.md#bounded-production-native-requests) | acknowledged | [Alpine acknowledgement](../../../fleet/alpine-linux/journal.md#2026-09-06-0328-utc--r06-production-shared-shell-request-acknowledged); run `r06-shared-e010086-alpine-20260906`, verification only |
