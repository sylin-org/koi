...
| [R07](R07-home-launchpad.md) | R05, R06 | in_progress | pending | cachyos-linux | [R07](reports/R07.md) | Guarded installed daemon17fb591 / desktop24d619f passed authoritative discovery, 320px draft/selection retention and durable favorite absent/restart/republication recovery. Earlier narrow Back/no-match/clear passed. Test workload/state cleaned; normal upgrade retained. Exact shared-source CI passed all14 jobs. Actual browser load/save and real pointer interaction require an operator-present manual session. No whole-R07 acceptance |
