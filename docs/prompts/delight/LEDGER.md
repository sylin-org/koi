...
| `R06/windows-recovery-tail` | cachyos-linux | windows | Installed exact ccee0fc; elevated independent recovery guard then service-loss/recovery only; no rebuild/reinstall; [procedure](reports/R06-renderer-decision.md#r06windows-recovery-tail) | acknowledged | [Windows retry acknowledgement](../../../fleet/windows/journal.md#2026-09-05-35--r06-windows-recovery-tail-retry-acknowledged); [prior prerequisite failure](../../../fleet/windows/journal.md#2026-09-05-34--r06-windows-recovery-tail-prerequisite-unavailable) preserved |
