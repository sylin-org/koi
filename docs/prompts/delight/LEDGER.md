...
| [R07](R07-home-launchpad.md) | R05, R06 | in_progress | pending | cachyos-linux | [R07](reports/R07.md) | Native 320px selection-refresh/Back, no-match/clear and stale-read recovery passed at 46206b0 / desktop 6dd641b. Authoritative discovery availability now implemented with compatibility/API/UI checks; guarded daemon/native deployment plus durable Notes/favorite and browser/pointer journey remain pending |
