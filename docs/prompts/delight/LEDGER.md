...
| `R06/alpine-keyboard-tail` | cachyos-linux | alpine-linux | Installed exact ccee0fc; visible focus with ordinary operator/native input only; no rebuild, permission change or daemon mutation; [procedure](reports/R06-renderer-decision.md#r06alpine-keyboard-tail) | failed | [Alpine prerequisite result](../../../fleet/alpine-linux/journal.md#2026-09-05-2310-utc--r06-alpine-keyboard-tail-prerequisite-unavailable); no permitted native input route, evaluation not launched, prior proof and deployment preserved |
| `R06/windows-recovery-tail` | cachyos-linux | windows | Installed exact ccee0fc; elevated independent recovery guard then service-loss/recovery only; no rebuild/reinstall; [procedure](reports/R06-renderer-decision.md#r06windows-recovery-tail) | failed | [Windows journal](../../../fleet/windows/journal.md#2026-09-05-34--r06-windows-recovery-tail-prerequisite-unavailable) — dispatched shell remained medium-integrity with no administrator token, so the mandatory independent recovery guard could not be armed; service was not stopped and prior positive proof is preserved |
