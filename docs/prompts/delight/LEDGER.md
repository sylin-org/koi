...
| `R06/alpine-packaged-motion-v2` | cachyos-linux | alpine-linux | Exact desktop `ccee0fc` / shared `72cb286`; native musl retry and actual GTK preference boundary; [corrected procedure](reports/R06-renderer-decision.md#corrected-packaged-peer-requests) | acknowledged | [Alpine journal](../../../fleet/alpine-linux/journal.md#2026-09-05-2134-utc--r06-corrected-packaged-motion-request-acknowledged); old issue 001 remains open |
