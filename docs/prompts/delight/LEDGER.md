...
| [R07](R07-home-launchpad.md) | R05, R06 | in_progress | pending | cachyos-linux | [R07](reports/R07.md) | Installed CachyOS search/retry observed; 320px refresh hid selection, so candidate restored. Shared fragment correction passes focused checks; corrected native/browser journey and acceptance reconciliation remain pending |
