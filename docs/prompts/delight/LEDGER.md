...
| `R06/windows-packaged-motion-v2` | cachyos-linux | windows | Exact desktop `ccee0fc` / shared `72cb286`; native package and physical motion/lifecycle proof; [corrected procedure](reports/R06-renderer-decision.md#corrected-packaged-peer-requests) | acknowledged | [Windows acknowledgement](../../../fleet/windows/journal.md#2026-09-05-31--r06-windows-packaged-motion-v2-acknowledged) |
