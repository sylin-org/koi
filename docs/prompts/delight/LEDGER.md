...
| [R07](R07-home-launchpad.md) | R05, R06 | in_progress | pending | cachyos-linux | [R07](reports/R07.md) | Installed daemon17fb591 / desktop24d619f passed authoritative discovery, 320px draft/selection retention and durable favorite absent/restart/republication recovery. Exact shared-source CI passed all14 jobs. Generated-pointer wide selection/Back and narrow search/select/Back/no-match/clear now passed; normal layout restored. ADR-046 installed Koi c89f237 / desktop5388b71 proves temporary/remembered connection, native controls/revocation, trusted private HTTPS and CertMesh-loss/no-downgrade recovery. All14 final CI jobs passed. The retained host NSS correction now permits actual browser Home → Notes → save/reload/Back/reopen and native external Open with saved content; physical phone proof remains pending. No whole-R07 acceptance |
...
|---|---|---|---|---|---|
| `R06/windows-home-return-v2` | cachyos-linux | windows | Exact desktop d948015/shared b4c32fa; normal NSIS, repeated physical Advanced → Home and missing tray-menu case; [procedure and expiry](reports/R06-home-return.md#bounded-replacement-native-requests) | completed | [Windows accepted result](../../../fleet/windows/journal.md#2026-09-06-40--r06-windows-home-return-v2-result): all three physical 320 px Advanced → Home round trips, immediate/settled/repeated activation, legacy tabs, refresh, actual tray-menu Open Workbench and singleton pass; corrected package retained |
| `R06/alpine-home-return-v2` | cachyos-linux | alpine-linux | Exact desktop d948015, APKBUILD d432b9e/shared b4c32fa; targeted native navigation/lifecycle regression; [procedure and expiry](reports/R06-home-return.md#bounded-replacement-native-requests) | completed | [Alpine pass](../../../fleet/alpine-linux/journal.md#2026-09-06-0543-utc--r06-home-return-replacement-accepted-on-alpine); run `r06-home-d948015-alpine-20260906`; 3 same-PID native Advanced→Home returns, refresh, legacy tabs, tray/menu/singleton pass; exact cleanup complete |
...
| `R06/windows-packaged-motion-v2` | cachyos-linux | windows | Exact desktop `ccee0fc` / shared `72cb286`; native package and physical motion/lifecycle proof; [corrected procedure](reports/R06-renderer-decision.md#corrected-packaged-peer-requests) | failed | [Windows result](../../../fleet/windows/journal.md#2026-09-05-33--r06-windows-packaged-motion-v2-result) — motion/focus/offline/lifecycle pass; required service-unavailable/recovery case unverified because an elevated restart guard could not be armed |
| `R06/alpine-packaged-motion-v2` | cachyos-linux | alpine-linux | Exact desktop `ccee0fc` / shared `72cb286`; native musl retry and actual GTK preference boundary; [corrected procedure](reports/R06-renderer-decision.md#corrected-packaged-peer-requests) | completed | [Alpine accepted run](../../../fleet/alpine-linux/journal.md#2026-09-05-2234-utc--r06-corrected-packaged-motion-accepted); issue 001 resolved; keyboard focus explicitly unverified without a safe host input seam |
| `R06/alpine-keyboard-tail` | cachyos-linux | alpine-linux | Installed exact ccee0fc; visible focus with ordinary operator/native input only; no rebuild, permission change or daemon mutation; [procedure](reports/R06-renderer-decision.md#r06alpine-keyboard-tail) | completed | [Alpine accepted retry](../../../fleet/alpine-linux/journal.md#2026-09-06-0131-utc--r06-alpine-keyboard-tail-accepted); [prior prerequisite failure](../../../fleet/alpine-linux/journal.md#2026-09-05-2310-utc--r06-alpine-keyboard-tail-prerequisite-unavailable) preserved |
| `R06/windows-recovery-tail` | cachyos-linux | windows | Installed exact ccee0fc; elevated independent recovery guard then service-loss/recovery only; no rebuild/reinstall; [procedure](reports/R06-renderer-decision.md#r06windows-recovery-tail) | completed | [Windows accepted retry](../../../fleet/windows/journal.md#2026-09-05-36--r06-windows-recovery-tail-accepted); [prior prerequisite failure](../../../fleet/windows/journal.md#2026-09-05-34--r06-windows-recovery-tail-prerequisite-unavailable) preserved |
