...
| [R07](R07-home-launchpad.md) | R05, R06 | in_progress | pending | cachyos-linux | [R07](reports/R07.md) | Search/select/open and automatic snapshot recovery published; focused checks and real Chromium DOM preservation pass; exact installed/browser journey and acceptance reconciliation remain pending |
