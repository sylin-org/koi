...
| [R07](R07-home-launchpad.md) | R05, R06 | in_progress | pending | cachyos-linux | [R07](reports/R07.md) | Search → select → open source published in shared/native adapters; focused checks pass; exact browser/native journey verification and automatic reconnect remain pending |
