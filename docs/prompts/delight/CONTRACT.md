...
| Source-scoped mDNS evidence | `koi-common::integration::MdnsDiscoverySnapshot` plus the proposed observation fields fixed by R03 | catalog, DNS, Health | existing shape extended by R03 |
