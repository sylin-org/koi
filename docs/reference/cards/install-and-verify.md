...
#   koi: koi v0.4.2 installed -> ~/.local/bin/koi
#   <koi status output>
...
gh attestation verify oci://ghcr.io/sylin-org/koi:v0.4.2          --repo sylin-org/koi
```
...
| `KOI_VERSION` (`-Version`) | Pin a release tag, e.g. `v0.4.2`. **Default: latest release.** |
