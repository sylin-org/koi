...
| Private browser HTTPS (explicitly enabled) | `0.0.0.0:5645` (operator port + 4) | Browser invitations and scoped Home reads; usable CertMesh identity required; separate from mTLS and public Pond |
